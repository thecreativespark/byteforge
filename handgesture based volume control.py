...
# Interface GUID for IAudioEndpointVolume
interface_guid = GUID("{5CDF2C82-841E-4546-9722-0CF74078229A}")
interface = devices.Activate(interface_guid, CLSCTX_ALL, None)
...
while True:
 ...
 # from numpy we find our length,by converting hand range in terms of volume range ie b/w -63.5 to 0
        ...
        cv2.putText(img,f"{int(vlper)}%",(10,40),cv2.FONT_ITALIC,1,(0, 255, 98),3)
